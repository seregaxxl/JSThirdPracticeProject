...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindNavTriggers",
    value: function bindNavTriggers(navTrClass, direction) {
      var _this2 = this;

      document.querySelectorAll(navTrClass).forEach(function (item) {
    ...
    value: function bindTriggers() {
      ...
      this.bindNavTriggers('.prevmodule', -1);
      this.bindNavTriggers('.nextmodule', 1);
    }
  }, {
    key: "render",
